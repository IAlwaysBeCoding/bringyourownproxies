...
class YouPornVideo(OnlineVideo):
    ...
    def __init__(self,url=None,title=None,category=None,**kwargs):
        ...
        super(YouPornVideo,self).__init__(url=url,
                                        title=title,
                                        category=category,
...
class YouPornVideoUploadRequest(VideoUploadRequest):
    ...
    def create_video_settings(self):
        return {"title":str(self.title),
                ...
                "tags]":",".join([t.name for t in self.tags]),
                "pornstars":",".join([t.name for p in self.porn_stars]),
...
if __name__ == '__main__':
    youporn_video = YouPornVideo(url='http://www.youporn.com/watch/580485/fucking-his-coed-neighbors-daughter-in-shower')
    #youporn_video.get_video_info()
    #info = youporn_video.get_video_info()
    #print info
    youporn_video.download(name_to_save_as='daughter.mp4')
