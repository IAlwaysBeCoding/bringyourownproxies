...
from bringyourownproxies.video import (OnlineVideo,VideoUploadRequest,
                                        VideoUploaded,Category,Description,Title)
from bringyourownproxies.errors import (InvalidCategory,InvalidTitle,InvalidDescription)

__all__ = ['XhamsterTitle','XhamsterDescription',
        'XhamsterCategory','XhamsterCategoryStraight','XhamsterCategoryGay',
        'XhamsterCategoryTranssexual','XhamsterVideoUploadRequest','XhamsterVideoUploaded']
